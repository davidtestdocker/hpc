...
**本輪文件核對完成。** Week1～20 共 138／138 篇已逐篇閱讀並修正頁首；20 個每週 README 也已核對、同步閱讀方式。每課分開標示已存輸出、概念示例、缺少證據與程式落差；詳見[逐篇稽核清單](audits/curriculum-content-audit.md)及[重要問題總表](audits/curriculum-findings.md)。文件核對完成不等於所有實驗成功或所有程式缺陷已修復，連結／格式檢查也不能代替內容判讀。
